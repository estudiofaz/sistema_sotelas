...
<span class='line'>  2</span> Copyright (c) 2003-2012, CKSource - Frederico Knabben. All rights reserved.
...
<span class='line'> 50</span>  * &lt;li>&lt;code>action&lt;/code> &ndash; &lt;code>Browse&lt;/code> or &lt;code>QuickUpload&lt;/code>.&lt;/li>
<span class='line'> 51</span>  * &lt;li>&lt;code>target&lt;/code> &ndash; the field to update in the &lt;code>&lt;em>tabId:elementId&lt;/em>&lt;/code> format.&lt;/li>
<span class='line'> 52</span>  * &lt;li>&lt;code>params&lt;/code> &ndash; additional arguments to be passed to the server connector (optional).&lt;/li>
<span class='line'> 53</span>  * &lt;li>&lt;code>onSelect&lt;/code> &ndash; a function to execute when the file is selected/uploaded (optional).&lt;/li>
<span class='line'> 54</span>  * &lt;li>&lt;code>url&lt;/code> &ndash; the URL to be called (optional).&lt;/li>
...
<span class='line'>325</span> </span><span class="WHIT">		</span><span class="COMM">// If there is a reference to targetElement, update it.</span><span class="WHIT">
<span class='line'>326</span> </span><span class="WHIT">		</span><span class="KEYW">if</span><span class="WHIT"> </span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">targetElement</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="WHIT">
<span class='line'>327</span> </span><span class="WHIT">		</span><span class="PUNC">{</span><span class="WHIT">
<span class='line'>328</span> </span><span class="WHIT">			</span><span class="KEYW">var</span><span class="WHIT"> </span><span class="NAME">target</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="NAME">targetElement.split</span><span class="PUNC">(</span><span class="WHIT"> </span><span class="STRN">':'</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>329</span> </span><span class="WHIT">			</span><span class="KEYW">var</span><span class="WHIT"> </span><span class="NAME">element</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="NAME">dialog.getContentElement</span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">target</span><span class="PUNC">[</span><span class="WHIT"> </span><span class="NUMB">0</span><span class="WHIT"> </span><span class="PUNC">]</span><span class="PUNC">,</span><span class="WHIT"> </span><span class="NAME">target</span><span class="PUNC">[</span><span class="WHIT"> </span><span class="NUMB">1</span><span class="WHIT"> </span><span class="PUNC">]</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>330</span> </span><span class="WHIT">			</span><span class="KEYW">if</span><span class="WHIT"> </span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">element</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="WHIT">
<span class='line'>331</span> </span><span class="WHIT">			</span><span class="PUNC">{</span><span class="WHIT">
<span class='line'>332</span> </span><span class="WHIT">				</span><span class="NAME">element.setValue</span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">url</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>333</span> </span><span class="WHIT">				</span><span class="NAME">dialog.selectPage</span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">target</span><span class="PUNC">[</span><span class="WHIT"> </span><span class="NUMB">0</span><span class="WHIT"> </span><span class="PUNC">]</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
...
<span class='line'>339</span> 	 * Returns true if filebrowser is configured in one of the elements.
<span class='line'>340</span> 	 *
<span class='line'>341</span> 	 * @param {CKEDITOR.dialog.definitionObject}
<span class='line'>342</span> 	 *            definition Dialog definition.
<span class='line'>343</span> 	 * @param String
<span class='line'>344</span> 	 *            tabId The tab id where element(s) can be found.
<span class='line'>345</span> 	 * @param String
<span class='line'>346</span> 	 *            elementId The element id (or ids, separated with a semicolon) to check.
<span class='line'>347</span> 	 */</span><span class="WHIT">
<span class='line'>348</span> </span><span class="WHIT">	</span><span class="KEYW">function</span><span class="WHIT"> </span><span class="NAME">isConfigured</span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">definition</span><span class="PUNC">,</span><span class="WHIT"> </span><span class="NAME">tabId</span><span class="PUNC">,</span><span class="WHIT"> </span><span class="NAME">elementId</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="WHIT">
<span class='line'>349</span> </span><span class="WHIT">	</span><span class="PUNC">{</span><span class="WHIT">
<span class='line'>350</span> </span><span class="WHIT">		</span><span class="KEYW">if</span><span class="WHIT"> </span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">elementId.indexOf</span><span class="PUNC">(</span><span class="WHIT"> </span><span class="STRN">";"</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="WHIT"> </span><span class="PUNC">!==</span><span class="WHIT"> </span><span class="PUNC">-</span><span class="NUMB">1</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="WHIT">
<span class='line'>351</span> </span><span class="WHIT">		</span><span class="PUNC">{</span><span class="WHIT">
<span class='line'>352</span> </span><span class="WHIT">			</span><span class="KEYW">var</span><span class="WHIT"> </span><span class="NAME">ids</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="NAME">elementId.split</span><span class="PUNC">(</span><span class="WHIT"> </span><span class="STRN">";"</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>353</span> </span><span class="WHIT">			</span><span class="KEYW">for</span><span class="WHIT"> </span><span class="PUNC">(</span><span class="WHIT"> </span><span class="KEYW">var</span><span class="WHIT"> </span><span class="NAME">i</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="NUMB">0</span><span class="WHIT"> </span><span class="PUNC">;</span><span class="WHIT"> </span><span class="NAME">i</span><span class="WHIT"> </span><span class="PUNC">&lt;</span><span class="WHIT"> </span><span class="NAME">ids.length</span><span class="WHIT"> </span><span class="PUNC">;</span><span class="WHIT"> </span><span class="NAME">i</span><span class="PUNC">++</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="WHIT">
<span class='line'>354</span> </span><span class="WHIT">			</span><span class="PUNC">{</span><span class="WHIT">
<span class='line'>355</span> </span><span class="WHIT">				</span><span class="KEYW">if</span><span class="WHIT"> </span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">isConfigured</span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">definition</span><span class="PUNC">,</span><span class="WHIT"> </span><span class="NAME">tabId</span><span class="PUNC">,</span><span class="WHIT"> </span><span class="NAME">ids</span><span class="PUNC">[</span><span class="NAME">i</span><span class="PUNC">]</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="WHIT">
...
<span class='line'>361</span> </span><span class="WHIT">		</span><span class="KEYW">var</span><span class="WHIT"> </span><span class="NAME">elementFileBrowser</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="NAME">definition.getContents</span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">tabId</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="PUNC">.</span><span class="NAME">get</span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">elementId</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="PUNC">.</span><span class="NAME">filebrowser</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>362</span> </span><span class="WHIT">		</span><span class="KEYW">return</span><span class="WHIT"> </span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">elementFileBrowser</span><span class="WHIT"> </span><span class="PUNC">&&</span><span class="WHIT"> </span><span class="NAME">elementFileBrowser.url</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>363</span> </span><span class="WHIT">	</span><span class="PUNC">}</span><span class="WHIT">
<span class='line'>364</span> 
<span class='line'>365</span> </span><span class="WHIT">	</span><span class="KEYW">function</span><span class="WHIT"> </span><span class="NAME">setUrl</span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">fileUrl</span><span class="PUNC">,</span><span class="WHIT"> </span><span class="NAME">data</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="WHIT">
<span class='line'>366</span> </span><span class="WHIT">	</span><span class="PUNC">{</span><span class="WHIT">
<span class='line'>367</span> </span><span class="WHIT">		</span><span class="KEYW">var</span><span class="WHIT"> </span><span class="NAME">dialog</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="NAME">this._.filebrowserSe.getDialog</span><span class="PUNC">(</span><span class="PUNC">)</span><span class="PUNC">,</span><span class="WHIT">
<span class='line'>368</span> </span><span class="WHIT">			</span><span class="NAME">targetInput</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="NAME">this._.filebrowserSe</span><span class="PUNC">[</span><span class="WHIT"> </span><span class="STRN">'for'</span><span class="WHIT"> </span><span class="PUNC">]</span><span class="PUNC">,</span><span class="WHIT">
<span class='line'>369</span> </span><span class="WHIT">			</span><span class="NAME">onSelect</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="NAME">this._.filebrowserSe.filebrowser.onSelect</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>370</span> 
<span class='line'>371</span> </span><span class="WHIT">		</span><span class="KEYW">if</span><span class="WHIT"> </span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">targetInput</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="WHIT">
...
<span class='line'>374</span> </span><span class="WHIT">		</span><span class="KEYW">if</span><span class="WHIT"> </span><span class="PUNC">(</span><span class="WHIT"> </span><span class="KEYW">typeof</span><span class="WHIT"> </span><span class="NAME">data</span><span class="WHIT"> </span><span class="PUNC">==</span><span class="WHIT"> </span><span class="STRN">'function'</span><span class="WHIT"> </span><span class="PUNC">&&</span><span class="WHIT"> </span><span class="NAME">data.call</span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">this._.filebrowserSe</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="WHIT"> </span><span class="PUNC">===</span><span class="WHIT"> </span><span class="KEYW">false</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="WHIT">
...
<span class='line'>377</span> </span><span class="WHIT">		</span><span class="KEYW">if</span><span class="WHIT"> </span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">onSelect</span><span class="WHIT"> </span><span class="PUNC">&&</span><span class="WHIT"> </span><span class="NAME">onSelect.call</span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">this._.filebrowserSe</span><span class="PUNC">,</span><span class="WHIT"> </span><span class="NAME">fileUrl</span><span class="PUNC">,</span><span class="WHIT"> </span><span class="NAME">data</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="WHIT"> </span><span class="PUNC">===</span><span class="WHIT"> </span><span class="KEYW">false</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="WHIT">
<span class='line'>378</span> </span><span class="WHIT">			</span><span class="KEYW">return</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>379</span> 
<span class='line'>380</span> </span><span class="WHIT">		</span><span class="COMM">// The "data" argument may be used to pass the error message to the editor.</span><span class="WHIT">
<span class='line'>381</span> </span><span class="WHIT">		</span><span class="KEYW">if</span><span class="WHIT"> </span><span class="PUNC">(</span><span class="WHIT"> </span><span class="KEYW">typeof</span><span class="WHIT"> </span><span class="NAME">data</span><span class="WHIT"> </span><span class="PUNC">==</span><span class="WHIT"> </span><span class="STRN">'string'</span><span class="WHIT"> </span><span class="PUNC">&&</span><span class="WHIT"> </span><span class="NAME">data</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="WHIT">
<span class='line'>382</span> </span><span class="WHIT">			</span><span class="NAME">alert</span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">data</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>383</span> 
<span class='line'>384</span> </span><span class="WHIT">		</span><span class="KEYW">if</span><span class="WHIT"> </span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">fileUrl</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="WHIT">
<span class='line'>385</span> </span><span class="WHIT">			</span><span class="NAME">updateTargetElement</span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">fileUrl</span><span class="PUNC">,</span><span class="WHIT"> </span><span class="NAME">this._.filebrowserSe</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>386</span> </span><span class="WHIT">	</span><span class="PUNC">}</span><span class="WHIT">
<span class='line'>387</span> 
<span class='line'>388</span> </span><span class="WHIT">	</span><span class="NAME">CKEDITOR.plugins.add</span><span class="PUNC">(</span><span class="WHIT"> </span><span class="STRN">'filebrowser'</span><span class="PUNC">,</span><span class="WHIT">
<span class='line'>389</span> </span><span class="WHIT">	</span><span class="PUNC">{</span><span class="WHIT">
<span class='line'>390</span> </span><span class="WHIT">		</span><span class="NAME">init</span><span class="WHIT"> </span><span class="PUNC">:</span><span class="WHIT"> </span><span class="KEYW">function</span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">editor</span><span class="PUNC">,</span><span class="WHIT"> </span><span class="NAME">pluginPath</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="WHIT">
<span class='line'>391</span> </span><span class="WHIT">		</span><span class="PUNC">{</span><span class="WHIT">
<span class='line'>392</span> </span><span class="WHIT">			</span><span class="NAME">editor._.filebrowserFn</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="NAME">CKEDITOR.tools.addFunction</span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">setUrl</span><span class="PUNC">,</span><span class="WHIT"> </span><span class="NAME">editor</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>393</span> </span><span class="WHIT">			</span><span class="NAME">editor.on</span><span class="PUNC">(</span><span class="WHIT"> </span><span class="STRN">'destroy'</span><span class="PUNC">,</span><span class="WHIT"> </span><span class="KEYW">function</span><span class="WHIT"> </span><span class="PUNC">(</span><span class="PUNC">)</span><span class="WHIT"> </span><span class="PUNC">{</span><span class="WHIT"> </span><span class="NAME">CKEDITOR.tools.removeFunction</span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">this._.filebrowserFn</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT"> </span><span class="PUNC">}</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>394</span> </span><span class="WHIT">		</span><span class="PUNC">}</span><span class="WHIT">
<span class='line'>395</span> </span><span class="WHIT">	</span><span class="PUNC">}</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>396</span> 
<span class='line'>397</span> </span><span class="WHIT">	</span><span class="NAME">CKEDITOR.on</span><span class="PUNC">(</span><span class="WHIT"> </span><span class="STRN">'dialogDefinition'</span><span class="PUNC">,</span><span class="WHIT"> </span><span class="KEYW">function</span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">evt</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="WHIT">
<span class='line'>398</span> </span><span class="WHIT">	</span><span class="PUNC">{</span><span class="WHIT">
<span class='line'>399</span> </span><span class="WHIT">		</span><span class="KEYW">var</span><span class="WHIT"> </span><span class="NAME">definition</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="NAME">evt.data.definition</span><span class="PUNC">,</span><span class="WHIT">
<span class='line'>400</span> </span><span class="WHIT">			</span><span class="NAME">element</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>401</span> </span><span class="WHIT">		</span><span class="COMM">// Associate filebrowser to elements with 'filebrowser' attribute.</span><span class="WHIT">
<span class='line'>402</span> </span><span class="WHIT">		</span><span class="KEYW">for</span><span class="WHIT"> </span><span class="PUNC">(</span><span class="WHIT"> </span><span class="KEYW">var</span><span class="WHIT"> </span><span class="NAME">i</span><span class="WHIT"> </span><span class="KEYW">in</span><span class="WHIT"> </span><span class="NAME">definition.contents</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="WHIT">
<span class='line'>403</span> </span><span class="WHIT">		</span><span class="PUNC">{</span><span class="WHIT">
<span class='line'>404</span> </span><span class="WHIT">			</span><span class="KEYW">if</span><span class="WHIT"> </span><span class="PUNC">(</span><span class="WHIT"> </span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">element</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="NAME">definition.contents</span><span class="PUNC">[</span><span class="WHIT"> </span><span class="NAME">i</span><span class="WHIT"> </span><span class="PUNC">]</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="WHIT">
<span class='line'>405</span> </span><span class="WHIT">			</span><span class="PUNC">{</span><span class="WHIT">
<span class='line'>406</span> </span><span class="WHIT">				</span><span class="NAME">attachFileBrowser</span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">evt.editor</span><span class="PUNC">,</span><span class="WHIT"> </span><span class="NAME">evt.data.name</span><span class="PUNC">,</span><span class="WHIT"> </span><span class="NAME">definition</span><span class="PUNC">,</span><span class="WHIT"> </span><span class="NAME">element.elements</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>407</span> </span><span class="WHIT">				</span><span class="KEYW">if</span><span class="WHIT"> </span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">element.hidden</span><span class="WHIT"> </span><span class="PUNC">&&</span><span class="WHIT"> </span><span class="NAME">element.filebrowser</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="WHIT">
<span class='line'>408</span> </span><span class="WHIT">				</span><span class="PUNC">{</span><span class="WHIT">
<span class='line'>409</span> </span><span class="WHIT">					</span><span class="NAME">element.hidden</span><span class="WHIT"> </span><span class="PUNC">=</span><span class="WHIT"> </span><span class="PUNC">!</span><span class="NAME">isConfigured</span><span class="PUNC">(</span><span class="WHIT"> </span><span class="NAME">definition</span><span class="PUNC">,</span><span class="WHIT"> </span><span class="NAME">element</span><span class="PUNC">[</span><span class="WHIT"> </span><span class="STRN">'id'</span><span class="WHIT"> </span><span class="PUNC">]</span><span class="PUNC">,</span><span class="WHIT"> </span><span class="NAME">element.filebrowser</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
...
<span class='line'>413</span> </span><span class="WHIT">	</span><span class="PUNC">}</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>414</span> 
<span class='line'>415</span> </span><span class="PUNC">}</span><span class="WHIT"> </span><span class="PUNC">)</span><span class="PUNC">(</span><span class="PUNC">)</span><span class="PUNC">;</span><span class="WHIT">
<span class='line'>416</span> 
<span class='line'>417</span> </span><span class="COMM">/**
<span class='line'>418</span>  * The location of an external file browser that should be launched when the &lt;strong>Browse Server&lt;/strong>
<span class='line'>419</span>  * button is pressed. If configured, the &lt;strong>Browse Server&lt;/strong> button will appear in the
<span class='line'>420</span>  * &lt;strong>Link&lt;/strong>, &lt;strong>Image&lt;/strong>, and &lt;strong>Flash&lt;/strong> dialog windows.
<span class='line'>421</span>  * @see The &lt;a href="http://docs.cksource.com/CKEditor_3.x/Developers_Guide/File_Browser_(Uploader)">File Browser/Uploader&lt;/a> documentation.
<span class='line'>422</span>  * @name CKEDITOR.config.filebrowserBrowseUrl
<span class='line'>423</span>  * @since 3.0
<span class='line'>424</span>  * @type String
<span class='line'>425</span>  * @default &lt;code>''&lt;/code> (empty string = disabled)
<span class='line'>426</span>  * @example
<span class='line'>427</span>  * config.filebrowserBrowseUrl = '/browser/browse.php';
<span class='line'>428</span>  */</span><span class="WHIT">
<span class='line'>429</span> 
<span class='line'>430</span> </span><span class="COMM">/**
<span class='line'>431</span>  * The location of the script that handles file uploads.
<span class='line'>432</span>  * If set, the &lt;strong>Upload&lt;/strong> tab will appear in the &lt;strong>Link&lt;/strong>, &lt;strong>Image&lt;/strong>,
<span class='line'>433</span>  * and &lt;strong>Flash&lt;/strong> dialog windows.
<span class='line'>434</span>  * @name CKEDITOR.config.filebrowserUploadUrl
<span class='line'>435</span>  * @see The &lt;a href="http://docs.cksource.com/CKEditor_3.x/Developers_Guide/File_Browser_(Uploader)">File Browser/Uploader&lt;/a> documentation.
<span class='line'>436</span>  * @since 3.0
<span class='line'>437</span>  * @type String
<span class='line'>438</span>  * @default &lt;code>''&lt;/code> (empty string = disabled)
<span class='line'>439</span>  * @example
<span class='line'>440</span>  * config.filebrowserUploadUrl = '/uploader/upload.php';
<span class='line'>441</span>  */</span><span class="WHIT">
<span class='line'>442</span> 
<span class='line'>443</span> </span><span class="COMM">/**
<span class='line'>444</span>  * The location of an external file browser that should be launched when the &lt;strong>Browse Server&lt;/strong>
<span class='line'>445</span>  * button is pressed in the &lt;strong>Image&lt;/strong> dialog window.
<span class='line'>446</span>  * If not set, CKEditor will use &lt;code>{@link CKEDITOR.config.filebrowserBrowseUrl}&lt;/code>.
<span class='line'>447</span>  * @name CKEDITOR.config.filebrowserImageBrowseUrl
<span class='line'>448</span>  * @since 3.0
<span class='line'>449</span>  * @type String
<span class='line'>450</span>  * @default &lt;code>''&lt;/code> (empty string = disabled)
<span class='line'>451</span>  * @example
<span class='line'>452</span>  * config.filebrowserImageBrowseUrl = '/browser/browse.php?type=Images';
<span class='line'>453</span>  */</span><span class="WHIT">
<span class='line'>454</span> 
<span class='line'>455</span> </span><span class="COMM">/**
<span class='line'>456</span>  * The location of an external file browser that should be launched when the &lt;strong>Browse Server&lt;/strong>
<span class='line'>457</span>  * button is pressed in the &lt;strong>Flash&lt;/strong> dialog window.
<span class='line'>458</span>  * If not set, CKEditor will use &lt;code>{@link CKEDITOR.config.filebrowserBrowseUrl}&lt;/code>.
<span class='line'>459</span>  * @name CKEDITOR.config.filebrowserFlashBrowseUrl
<span class='line'>460</span>  * @since 3.0
<span class='line'>461</span>  * @type String
<span class='line'>462</span>  * @default &lt;code>''&lt;/code> (empty string = disabled)
<span class='line'>463</span>  * @example
<span class='line'>464</span>  * config.filebrowserFlashBrowseUrl = '/browser/browse.php?type=Flash';
<span class='line'>465</span>  */</span><span class="WHIT">
<span class='line'>466</span> 
<span class='line'>467</span> </span><span class="COMM">/**
<span class='line'>468</span>  * The location of the script that handles file uploads in the &lt;strong>Image&lt;/strong> dialog window.
<span class='line'>469</span>  * If not set, CKEditor will use &lt;code>{@link CKEDITOR.config.filebrowserUploadUrl}&lt;/code>.
<span class='line'>470</span>  * @name CKEDITOR.config.filebrowserImageUploadUrl
<span class='line'>471</span>  * @since 3.0
<span class='line'>472</span>  * @type String
<span class='line'>473</span>  * @default &lt;code>''&lt;/code> (empty string = disabled)
<span class='line'>474</span>  * @example
<span class='line'>475</span>  * config.filebrowserImageUploadUrl = '/uploader/upload.php?type=Images';
<span class='line'>476</span>  */</span><span class="WHIT">
<span class='line'>477</span> 
<span class='line'>478</span> </span><span class="COMM">/**
<span class='line'>479</span>  * The location of the script that handles file uploads in the &lt;strong>Flash&lt;/strong> dialog window.
<span class='line'>480</span>  * If not set, CKEditor will use &lt;code>{@link CKEDITOR.config.filebrowserUploadUrl}&lt;/code>.
<span class='line'>481</span>  * @name CKEDITOR.config.filebrowserFlashUploadUrl
<span class='line'>482</span>  * @since 3.0
<span class='line'>483</span>  * @type String
<span class='line'>484</span>  * @default &lt;code>''&lt;/code> (empty string = disabled)
<span class='line'>485</span>  * @example
<span class='line'>486</span>  * config.filebrowserFlashUploadUrl = '/uploader/upload.php?type=Flash';
<span class='line'>487</span>  */</span><span class="WHIT">
<span class='line'>488</span> 
<span class='line'>489</span> </span><span class="COMM">/**
<span class='line'>490</span>  * The location of an external file browser that should be launched when the &lt;strong>Browse Server&lt;/strong>
<span class='line'>491</span>  * button is pressed in the &lt;strong>Link&lt;/strong> tab of the &lt;strong>Image&lt;/strong> dialog window.
<span class='line'>492</span>  * If not set, CKEditor will use &lt;code>{@link CKEDITOR.config.filebrowserBrowseUrl}&lt;/code>.
<span class='line'>493</span>  * @name CKEDITOR.config.filebrowserImageBrowseLinkUrl
<span class='line'>494</span>  * @since 3.2
<span class='line'>495</span>  * @type String
<span class='line'>496</span>  * @default &lt;code>''&lt;/code> (empty string = disabled)
<span class='line'>497</span>  * @example
<span class='line'>498</span>  * config.filebrowserImageBrowseLinkUrl = '/browser/browse.php';
<span class='line'>499</span>  */</span><span class="WHIT">
<span class='line'>500</span> 
<span class='line'>501</span> </span><span class="COMM">/**
<span class='line'>502</span>  * The features to use in the file browser popup window.
<span class='line'>503</span>  * @name CKEDITOR.config.filebrowserWindowFeatures
<span class='line'>504</span>  * @since 3.4.1
<span class='line'>505</span>  * @type String
<span class='line'>506</span>  * @default &lt;code>'location=no,menubar=no,toolbar=no,dependent=yes,minimizable=no,modal=yes,alwaysRaised=yes,resizable=yes,scrollbars=yes'&lt;/code>
<span class='line'>507</span>  * @example
<span class='line'>508</span>  * config.filebrowserWindowFeatures = 'resizable=yes,scrollbars=no';
<span class='line'>509</span>  */</span><span class="WHIT">
<span class='line'>510</span> 
<span class='line'>511</span> </span><span class="COMM">/**
<span class='line'>512</span>  * The width of the file browser popup window. It can be a number denoting a value in
<span class='line'>513</span>  * pixels or a percent string.
<span class='line'>514</span>  * @name CKEDITOR.config.filebrowserWindowWidth
<span class='line'>515</span>  * @type Number|String
<span class='line'>516</span>  * @default &lt;code>'80%'&lt;/code>
<span class='line'>517</span>  * @example
<span class='line'>518</span>  * config.filebrowserWindowWidth = 750;
<span class='line'>519</span>  * @example
<span class='line'>520</span>  * config.filebrowserWindowWidth = '50%';
<span class='line'>521</span>  */</span><span class="WHIT">
<span class='line'>522</span> 
<span class='line'>523</span> </span><span class="COMM">/**
<span class='line'>524</span>  * The height of the file browser popup window. It can be a number denoting a value in
<span class='line'>525</span>  * pixels or a percent string.
<span class='line'>526</span>  * @name CKEDITOR.config.filebrowserWindowHeight
<span class='line'>527</span>  * @type Number|String
<span class='line'>528</span>  * @default &lt;code>'70%'&lt;/code>
<span class='line'>529</span>  * @example
<span class='line'>530</span>  * config.filebrowserWindowHeight = 580;
<span class='line'>531</span>  * @example
<span class='line'>532</span>  * config.filebrowserWindowHeight = '50%';
<span class='line'>533</span>  */</span><span class="WHIT">
<span class='line'>534</span> </span></pre></body></html>