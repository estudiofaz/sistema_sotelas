...
class Admin_CategoriaportfolioController extends Zend_Controller_Action
{
				...
				if ($files != null){
					...
					if($upload->isValid($file)){
						...
						$data = array(
							...
							$this->_redirect('/admin/categoriaportfolio/index/msg/2');
								
						}else{
							$this->_redirect('/admin/categoriaportfolio/index/msg/3');
						}
					}else{
				...
				if ($files != null){
					...
					if($upload->isValid($file)){
						...
						$data = array(	'descCategoria'		=>	$descCategoria,
							...
							$this->_redirect('/admin/categoriaportfolio/index/msg/1');
    ...
    public function delAction()
    {
		...
		$del = $this->getRequest()->getPost('up');
			if($del == 'Excluir'){
				...
				$this->_redirect('/admin/categoriaportfolio/index/msg/4');
			
			}elseif ($del == 'Cancelar'){
				
				$this->_redirect('/admin/categoriaportfolio/index');
			}
